function [delay_table,dis_table,TM,IM,timeslot,sequence,node,path,Ts] = generate_TDMA(N,Nx,Ny,Nz,dc,vs,N0,N1,N2,path1,n,t_data,Round,totaltimeslot);
...
% save((fullfile(path1,'TM'),'TM');
% save((fullfile(path1,'IM'),'IM');
% save((fullfile(path1,'delay_table'),'delay_table');
% save((fullfile(path1,'dis_table'),'dis_table');
 
% save((fullfile(path1,'timeslot'),'timeslot');
% save((fullfile(path1,'sequence'),'sequence');
% save((fullfile(path1,'node'),'node');
% save((fullfile(path1,'path'),'path');
% save((fullfile(path1,'Ts'),'Ts');

 delay_table = cell2mat(struct2cell(load(fullfile(path1,'delay_table'))));
dis_table = cell2mat(struct2cell(load(fullfile(path1,'dis_table'))));
TM = cell2mat(struct2cell(load(fullfile(path1,'TM'))));
IM = cell2mat(struct2cell(load(fullfile(path1,'IM'))));
 

timeslot = cell2mat(struct2cell(load(fullfile(path1,'timeslot'))));
sequence = cell2mat(struct2cell(load(fullfile(path1,'sequence'))));
node = cell2mat(struct2cell(load(fullfile(path1,'node'))));
path = cell2mat(struct2cell(load(fullfile(path1,'path'))));
Ts = cell2mat(struct2cell(load(fullfile(path1,'Ts'))));
