...
% save((fullfile(path1,'Nx'),'Nx');
% save((fullfile(path1,'Ny'),'Ny');
% save((fullfile(path1,'Nz'),'Nz');


%path1='D:\software\Matlab\install\work\LAB\zxxpaper\2021auv\results_compare\datarate\vbps_datarate';
Nx = cell2mat(struct2cell(load(fullfile(path1,'Nx'))));
Ny = cell2mat(struct2cell(load(fullfile(path1,'Ny'))));
Nz = cell2mat(struct2cell(load(fullfile(path1,'Nz'))));
