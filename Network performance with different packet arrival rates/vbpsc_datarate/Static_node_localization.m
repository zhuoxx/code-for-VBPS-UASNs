...
% static nodes.
% save((fullfile(path1,'AUV_listen'),'AUV_listen');
% save((fullfile(path1,'AUV_detected'),'AUV_detected');
% save((fullfile(path1,'AUV_in'),'AUV_in');

AUV_listen = cell2mat(struct2cell(load(fullfile(path1,'AUV_listen'))));
AUV_detected = cell2mat(struct2cell(load(fullfile(path1,'AUV_detected'))));
AUV_in = cell2mat(struct2cell(load(fullfile(path1,'AUV_in'))));
