%%%%%%%%%%%%%%%%%%%%%% Main file for VBPS-C with different datarate
...
path1 = 'C:\Users\zxx\Desktop\upload\Network performance with different packet arrival rates\vbpsc_datarate\networkdata'; %networkdata file path
path2 = 'C:\Users\zxx\Desktop\upload\Network performance with different packet arrival rates\vbpsc_datarate\plot_data'; %plotdata file path
...
% % 
% save(fullfile(path2,'20211220vbpscdatarate_vuvoi_choose'),'vuvoi_choose');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoi_collision'),'vuvoi_collision');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoi_plot'),'vuvoi_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoi_collision_plot'),'vuvoi_collision_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoi_plot_sum'),'vuvoi_plot_sum');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoi_collision_plot_sum'),'vuvoi_collision_plot_sum');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vuvoitotaldelay_choose'),'vuvoitotaldelay_choose');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoitotaldelay_plot'),'vuvoitotaldelay_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoisenddelay_choose'),'vuvoisenddelay_choose');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoisenddelay_plot'),'vuvoisenddelay_plot');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vuvoidiscardnodecount_plot'),'vuvoidiscardnodecount_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoicollisioncount_plot'),'vuvoicollisioncount_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoiauvcollisioncount_plot'),'vuvoiauvcollisioncount_plot');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vuvoithroughput_plot'),'vuvoithroughput_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoitotalthroughput_plot'),'vuvoitotalthroughput_plot');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vuvoiarrivaltime'),'vuvoiarrivaltime');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoitotaldelay_plot_sum'),'vuvoitotaldelay_plot_sum');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoisenddelay_plot_sum'),'vuvoisenddelay_plot_sum');

% save(fullfile(path2,'20211220vbpscdatarate_vmvoi_choose'),'vmvoi_choose');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoi_collision'),'vmvoi_collision');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoi_plot'),'vmvoi_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoi_collision_plot'),'vmvoi_collision_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoi_plot_sum'),'vmvoi_plot_sum');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoi_collision_plot_sum'),'vmvoi_collision_plot_sum');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vmvoitotaldelay_choose'),'vmvoitotaldelay_choose');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoitotaldelay_plot'),'vmvoitotaldelay_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoisenddelay_choose'),'vmvoisenddelay_choose');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoisenddelay_plot'),'vmvoisenddelay_plot');

% save(fullfile(path2,'20211220vbpscdatarate_vmvoidiscardnodecount_plot'),'vmvoidiscardnodecount_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoicollisioncount_plot'),'vmvoicollisioncount_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoiauvcollisioncount_plot'),'vmvoiauvcollisioncount_plot');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vmvoithroughput_plot'),'vmvoithroughput_plot');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoitotalthroughput_plot'),'vmvoitotalthroughput_plot');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vmvoiarrivaltime'),'vmvoiarrivaltime');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vmvoitotaldelay_plot_sum'),'vmvoitotaldelay_plot_sum');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoisenddelay_plot_sum'),'vmvoisenddelay_plot_sum');
iteration
end

 
 %% Calculate average  VoI, network throughput, congestion ratio, and  network delay
for iNA_plot =  1:NA
    for ivutrafficload =  1:length(vutrafficload)
        for ivmtrafficload =  1:length(vmtrafficload)
            vuvoitotaldelay_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vuvoitotaldelay_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vmvoitotaldelay_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vmvoitotaldelay_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vuvoisenddelay_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vuvoisenddelay_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vmvoisenddelay_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vmvoisenddelay_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                   
            
            vuvoidiscardnodecount_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vuvoidiscardnodecount_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vmvoidiscardnodecount_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vmvoidiscardnodecount_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vuvoicollisioncount_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vuvoicollisioncount_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vmvoicollisioncount_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vmvoicollisioncount_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vuvoiauvcollisioncount_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vuvoiauvcollisioncount_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vmvoiauvcollisioncount_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vmvoiauvcollisioncount_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
              vuvoithroughput_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vuvoithroughput_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vmvoithroughput_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vmvoithroughput_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vuvoi_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vuvoi_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vmvoi_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vmvoi_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
             vuvoi_collision_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vuvoi_collision_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vmvoi_collision_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vmvoi_collision_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
             vuvoitotalthroughput_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vuvoitotalthroughput_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
            vmvoitotalthroughput_vbpsc_average(iNA_plot,ivutrafficload,ivmtrafficload) =  sum(vmvoitotalthroughput_plot(iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
...
% %Save average VoI, network throughput, congestion ratio, and  network delay
% save(fullfile(path2,'20211220vbpscdatarate_vuvoi_vbpsc_average'),'vuvoi_vbpsc_average');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoi_collision_vbpsc_average'),'vuvoi_collision_vbpsc_average');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vuvoitotaldelay_vbpsc_average'),'vuvoitotaldelay_vbpsc_average');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoisenddelay_vbpsc_average'),'vuvoisenddelay_vbpsc_average');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vuvoidiscardnodecount_vbpsc_average'),'vuvoidiscardnodecount_vbpsc_average');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoicollisioncount_vbpsc_average'),'vuvoicollisioncount_vbpsc_average');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoiauvcollisioncount_vbpsc_average'),'vuvoiauvcollisioncount_vbpsc_average');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vuvoithroughput_vbpsc_average'),'vuvoithroughput_vbpsc_average');
% save(fullfile(path2,'20211220vbpscdatarate_vuvoitotalthroughput_vbpsc_average'),'vuvoitotalthroughput_vbpsc_average');
% 
% 
% 
% save(fullfile(path2,'20211220vbpscdatarate_vmvoi_vbpsc_average'),'vmvoi_vbpsc_average');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoi_collision_vbpsc_average'),'vmvoi_collision_vbpsc_average');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vmvoitotaldelay_vbpsc_average'),'vmvoitotaldelay_vbpsc_average');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoisenddelay_vbpsc_average'),'vmvoisenddelay_vbpsc_average');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vmvoidiscardnodecount_vbpsc_average'),'vmvoidiscardnodecount_vbpsc_average');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoicollisioncount_vbpsc_average'),'vmvoicollisioncount_vbpsc_average');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoiauvcollisioncount_vbpsc_average'),'vmvoiauvcollisioncount_vbpsc_average');
% 
% save(fullfile(path2,'20211220vbpscdatarate_vmvoithroughput_vbpsc_average'),'vmvoithroughput_vbpsc_average');
% save(fullfile(path2,'20211220vbpscdatarate_vmvoitotalthroughput_vbpsc_average'),'vmvoitotalthroughput_vbpsc_average');
% 
...
for ivutrafficload =  length(vutrafficload)%1:length(vmtrafficload)
    for i =  1:length(vmtrafficload)
        A(i) =  sum(vmvoithroughput_vbpsc_average(:,ivutrafficload,i)/t_data*L_packet);
    end
...
legend1 =  legend('\fontsize{16}\fontname{Times New Roman}VBPS-C','Location','NorthEast');
...
for ivutrafficload =  length(vutrafficload)%1:length(vmtrafficload)
    for i =  1:length(vmtrafficload)
        A(i) =  sum(vmvoi_collision_vbpsc_average(:,ivutrafficload,i));
    end
    plot(vmtrafficload(2:end),A(2:end).','o-b','LineWidth',1.8,'MarkerSize',8,'color',clr(6,:));
    hold on
end
...
for ivutrafficload =  length(vutrafficload)%1:length(vmtrafficload)
    for i =  1:length(vmtrafficload)
        A(i) =  sum(vmvoiauvcollisioncount_vbpsc_average(:,ivutrafficload,i))+sum(vmvoicollisioncount_vbpsc_average(:,ivutrafficload,i));
    end
    plot(vmtrafficload(2:end),A(2:end).','o-b','LineWidth',1.8,'MarkerSize',8,'color',clr(6,:));
    hold on
end
