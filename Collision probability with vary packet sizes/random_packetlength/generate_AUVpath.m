...
% generated path.
% save(fullfile(path1,'Ax3'),'Ax');
% save(fullfile(path1,'Ay3'),'Ay');
% save(fullfile(path1,'Az3'),'Az');
% save(fullfile(path1,'len_xyz3'),'len_xyz');

% path1 =  'D:\software\Matlab\install\work\LAB\zxxpaper\2021auv';

Ax = cell2mat(struct2cell(load(fullfile(path1,'Ax3'))));
Ay = cell2mat(struct2cell(load(fullfile(path1,'Ay3'))));
Az = cell2mat(struct2cell(load(fullfile(path1,'Az3'))));
len_xyz = cell2mat(struct2cell(load(fullfile(path1,'len_xyz3'))));
