...
% generated path.
% save(fullfile(path1,strcat('Ax',num2str(NA))),'Ax');
% save(fullfile(path1,strcat('Ay',num2str(NA))),'Ay');
% save(fullfile(path1,strcat('Az',num2str(NA))),'Az');
% save(fullfile(path1,strcat('len_xyz',num2str(NA))),'len_xyz');

 
Ax = cell2mat(struct2cell(load(fullfile(path1,strcat('Ax',num2str(NA))))));
Ay = cell2mat(struct2cell(load(fullfile(path1,strcat('Ay',num2str(NA))))));
Az = cell2mat(struct2cell(load(fullfile(path1,strcat('Az',num2str(NA))))));
len_xyz = cell2mat(struct2cell(load(fullfile(path1,strcat('len_xyz',num2str(NA))))));
...
% %随机生成一些节点作为探测点，最短路径规划 random node
% NR=10;
% for iNA=1:NA
%     for i=1:NR
