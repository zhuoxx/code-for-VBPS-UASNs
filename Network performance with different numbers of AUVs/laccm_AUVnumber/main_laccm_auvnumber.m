...
path1 = 'C:\Users\zxx\Desktop\upload\Network performance with different numbers of AUVs\laccm_AUVnumber\networkdata'; %networkdata file path
path2 = 'C:\Users\zxx\Desktop\upload\Network performance with different numbers of AUVs\laccm_AUVnumber\plot_data'; %plotdata file path
...
for iteration = 1:iteration_total
    for iNA_number = 1:5
        ...
        sendpacketnumber_static = slotnumber_static.*(N0+N1);%ÿ��timeslot����N0��N1�ڽ����ź�
        ...
        for ivutrafficload = 1:length(vutrafficload)  %pkt/s
            for ivmtrafficload = 1:length(vmtrafficload)
                ...
                for iNA_plot = 1:NA
                    ...
                    vuthroughput_plot(iNA_number,iNA_plot,iteration,ivutrafficload,ivmtrafficload) = (vuarrivaltime_plot(iNA_number,iNA_plot,iteration,ivutrafficload,ivmtrafficload)-sum(vudiscardnodecount(iNA_plot,:))-sum(vucollisioncount(iNA_plot,:))-sum(vuauvcollisioncount(iNA_plot,:)))*t_data/(len_xyz(iNA_plot)*timeplus-timestart-timeend);%吞吐�?
                ...
                for iNA_plot = 1:NA
                    ...
                    vmthroughput_plot(iNA_number,iNA_plot,iteration,ivutrafficload,ivmtrafficload) = (vmarrivaltime_plot(iNA_number,iNA_plot,iteration,ivutrafficload,ivmtrafficload)-sum(vmcollisioncount(iNA_plot,:))-sum(vmauvcollisioncount(iNA_plot,:)))*t_data/(len_xyz(iNA_plot)*timeplus-timestart-timeend);%吞吐�?
                ...
                %             vmvoi_choose(iNA_number,:,:,iteration,ivutrafficload,ivmtrafficload) = vmvoi;
    ...
    %     %%save
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vuauvcollisioncount'),'vuauvcollisioncount');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vusendauvrun_node_random'),'vusendauvrun_node_random');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vutotaldelay'),'vutotaldelay');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vutotaldelay_plot'),'vutotaldelay_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vusenddelay'),'vusenddelay');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vusenddelay_plot'),'vusenddelay_plot');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vudiscardnodecount_plot'),'vudiscardnodecount_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vucollisioncount_plot'),'vucollisioncount_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vuauvcollisioncount_plot'),'vuauvcollisioncount_plot');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vuthroughput_plot'),'vuthroughput_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vutotalthroughput_plot'),'vutotalthroughput_plot');
    %
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vuarrivaltime_plot'),'vuarrivaltime_plot');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vutotaldelay_plot_sum'),'vutotaldelay_plot_sum');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vusenddelay_plot_sum'),'vusenddelay_plot_sum');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmauvcollisioncount'),'vmauvcollisioncount');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmsendauvrun_node_random'),'vmsendauvrun_node_random');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmtotaldelay'),'vmtotaldelay');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmtotaldelay_plot'),'vmtotaldelay_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmsenddelay'),'vmsenddelay');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmsenddelay_plot'),'vmsenddelay_plot');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmdiscardnodecount_plot'),'vmdiscardnodecount_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmcollisioncount_plot'),'vmcollisioncount_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmauvcollisioncount_plot'),'vmauvcollisioncount_plot');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmthroughput_plot'),'vmthroughput_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmtotalthroughput_plot'),'vmtotalthroughput_plot');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmarrivaltime_plot'),'vmarrivaltime_plot');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmtotaldelay_plot_sum'),'vmtotaldelay_plot_sum');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmsenddelay_plot_sum'),'vmsenddelay_plot_sum');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vuvoi'),'vuvoi');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vuvoi_collision'),'vuvoi_collision');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vuvoi_plot'),'vuvoi_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vuvoi_collision_plot'),'vuvoi_collision_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vuvoi_plot_sum'),'vuvoi_plot_sum');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vuvoi_collision_plot_sum'),'vuvoi_collision_plot_sum');
    %
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmvoi'),'vmvoi');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmvoi_collision'),'vmvoi_collision');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmvoi_plot'),'vmvoi_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmvoi_collision_plot'),'vmvoi_collision_plot');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmvoi_plot_sum'),'vmvoi_plot_sum');
    % save(fullfile(path2,'20211220laccmauvnodenumbers_vmvoi_collision_plot_sum'),'vmvoi_collision_plot_sum');
    iteration
end
...
for iNA_number = 1:5
    for iNA_plot = 1:NA
        for ivutrafficload = 1:length(vutrafficload)
            for ivmtrafficload = 1:length(vmtrafficload)
                vutotaldelay_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vutotaldelay_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vmtotaldelay_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vmtotaldelay_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vusenddelay_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vusenddelay_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vmsenddelay_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vmsenddelay_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                
                vudiscardnodecount_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vudiscardnodecount_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vmdiscardnodecount_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vmdiscardnodecount_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vucollisioncount_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vucollisioncount_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vmcollisioncount_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vmcollisioncount_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vuauvcollisioncount_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vuauvcollisioncount_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vmauvcollisioncount_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vmauvcollisioncount_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vuthroughput_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vuthroughput_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vmthroughput_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vmthroughput_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vutotalthroughput_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vutotalthroughput_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vmtotalthroughput_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vmtotalthroughput_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                
                vuvoi_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vuvoi_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vmvoi_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vmvoi_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vuvoi_collision_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vuvoi_collision_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
                vmvoi_collision_laccm_average(iNA_number,iNA_plot,ivutrafficload,ivmtrafficload) = sum(vmvoi_collision_plot(iNA_number,iNA_plot,:,ivutrafficload,ivmtrafficload))/iteration_total;
...
%     %%delay
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vutotaldelay_laccm_average'),'vutotaldelay_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vusenddelay_laccm_average'),'vusenddelay_laccm_average');
%
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vudiscardnodecount_laccm_average'),'vudiscardnodecount_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vuauvcollisioncount_laccm_average'),'vuauvcollisioncount_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vucollisioncount_laccm_average'),'vucollisioncount_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vuthroughput_laccm_average'),'vuthroughput_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vutotalthroughput_laccm_average'),'vutotalthroughput_laccm_average');
%
%
%
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vmtotaldelay_laccm_average'),'vmtotaldelay_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vmsenddelay_laccm_average'),'vmsenddelay_laccm_average');
%
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vmdiscardnodecount_laccm_average'),'vmdiscardnodecount_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vmcollisioncount_laccm_average'),'vmcollisioncount_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vmauvcollisioncount_laccm_average'),'vmauvcollisioncount_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vmthroughput_laccm_average'),'vmthroughput_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vmtotalthroughput_laccm_average'),'vmtotalthroughput_laccm_average');
%
%
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vuvoi_laccm_average'),'vuvoi_laccm_average');
%
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vuvoi_collision_laccm_average'),'vuvoi_collision_laccm_average');
%
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vmvoi_laccm_average'),'vmvoi_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vmvoi_collision_laccm_average'),'vmvoi_collision_laccm_average');
%
%
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vuvoi_laccm_average'),'vuvoi_laccm_average');
%     save(fullfile(path2,'20211220laccmauvnodenumbers_vuvoi_collision_laccm_average'),'vuvoi_collision_laccm_average');
...
for iNA_number = 1:5%1:length(vmtrafficload)
    ...
    A5(iNA_number) = sum(vmauvcollisioncount_laccm_average(iNA_number,:));
end
...
for iNA_number = 1:5
    vuvoi_vbps(iNA_number,:) = vuvoi_collision_laccm_average(iNA_number,:)+vmvoi_collision_laccm_average(iNA_number,:);
end
