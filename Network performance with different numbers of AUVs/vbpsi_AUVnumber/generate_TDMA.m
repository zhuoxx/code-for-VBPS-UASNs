...
% save(fullfile(path1,'timeslot3'),'timeslot');
% save(fullfile(path1,'sequence3'),'sequence');
% save(fullfile(path1,'node3'),'node');
% save(fullfile(path1,'path3'),'path');
% save(fullfile(path1,'Ts3'),'Ts');
...
timeslot = cell2mat(struct2cell(load(fullfile(path1,'timeslot3'))));
sequence = cell2mat(struct2cell(load(fullfile(path1,'sequence3'))));
node = cell2mat(struct2cell(load(fullfile(path1,'node3'))));
path = cell2mat(struct2cell(load(fullfile(path1,'path3'))));
Ts = cell2mat(struct2cell(load(fullfile(path1,'Ts3'))));
